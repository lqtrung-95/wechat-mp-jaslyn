...
Page({
    data: {
        ...
        pageCopy: getLanguagePack(DEFAULT_LANGUAGE, 'delivery').pageCopy,
        countries: [],
        countryOptions: [],
        cityOptions: [],
    ...
    initLanguage() {
        ...
        const pack = getLanguagePack(stored || DEFAULT_LANGUAGE, 'delivery');
    ...
    toggleLanguage() {
        ...
        const pack = getLanguagePack(next, 'delivery');
        this.applyLanguagePack(pack);
    },
    loadCountries() {
        const formatted = FOOD_REGIONS.map((item) => ({
    ...
    handleCountryChange(event) {
        ...
        const { countryOptions, globalCopy } = this.data;
    ...
    handleValidateAddress() {
        ...
        validateAddress(SERVICE_TYPES.FOOD, {
            country,
            city,
