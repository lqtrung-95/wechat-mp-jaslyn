export const FOOD_REGIONS = [
    ...
    },
    {
        ...
        countryCode: 'DE',
        flag: '🇩🇪',
        cities: ['柏林 Berlin', '慕尼黑 Munich', '法兰克福 Frankfurt'],
    },
    {
        country: '澳大利亚',
        countryEn: 'Australia',
        countryCode: 'AU',
        flag: '🇦🇺',
        cities: ['悉尼 Sydney', '墨尔本 Melbourne', '布里斯班 Brisbane'],
    },
    {
        country: '柬埔寨',
        countryEn: 'Cambodia',
...
export const FOOD_SUPPORTED_COUNTRIES = FOOD_REGIONS.map((item) => item.country);
